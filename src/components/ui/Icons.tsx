/**
 * Icons.tsx
 * Komponen ikon SVG outline minimalis modern (terinspirasi dari Lucide & Heroicons).
 * Semua ikon mewarisi warna teks saat ini (currentColor) dan memiliki ukuran default 20px (w-5 h-5).
 */
...
export function PackageIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M11 21.73a2 2 0 0 0 2 0l9.24-5.3a2 2 0 0 0 1-1.73V4.3a2 2 0 0 0-1-1.73L13 1.73a2 2 0 0 0-2 0L1.76 7.03a2 2 0 0 0-1 1.73V16.3a2 2 0 0 0 1 1.73z" />
      <path d="M12 22V12" />
      <path d="m12 12 8.76-5.03" />
      <path d="M12 12 3.24 6.97" />
      <path d="M5 4.5v3.5" />
    </svg>
  );
}

export function StockIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function ReportIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PromoIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-tag ${className}`}
      {...props}
    >
      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.41 2.41 0 0 0 3.405 0l5.889-5.889a2.41 2.41 0 0 0 0-3.405z" />
      <circle cx="7.5" cy="7.5" r="1.5" fill="currentColor" />
    </svg>
  );
}

export function ShiftIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function ScanIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-scan ${className}`}
      {...props}
    >
...
export function CameraIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-camera ${className}`}
      {...props}
    >
